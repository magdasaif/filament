...
class EmployeesRelationManager extends RelationManager
{
    ...
    {
        // This method can be used to determine if the relation manager should be read-only.
        // For example, you might want to make it read-only based on some condition.
        // Here, we return false to allow editing.
        return false;
    }
}
